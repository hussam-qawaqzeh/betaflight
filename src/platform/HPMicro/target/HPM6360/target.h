...
/*
 * Target configuration and feature selection for the HPM6360 MCU.
 */
...
/* ============================================================================
 * Device Unique ID (TODO: Read from hardware UID registers)
 * ========================================================================== */
...
#define USE_MOTOR
#define UNIFIED_SERIAL_PORT_COUNT 9
...
#define USBD_PRODUCT_STRING     "HPM6300 Platform"
#endif
...
#define UART_DIR_SWITCH_GPTMR         HPM_GPTMR2
#endif

#ifndef UART_DIR_SWITCH_GPTMR_CLOCK
#define UART_DIR_SWITCH_GPTMR_CLOCK   clock_gptmr2
#endif

#ifndef UART_DIR_SWITCH_GPTMR_IRQ
#define UART_DIR_SWITCH_GPTMR_IRQ     IRQn_GPTMR2
#endif
...
#ifndef SDXC_CD_PIN
#define SDXC_CD_PIN        DEFIO_TAG(PY5)
#endif

#ifndef SDXC_CD_PIN_AF
#define SDXC_CD_PIN_AF     IOC_PY05_FUNC_CTL_GPIO_Y_05
#endif

#ifndef SDXC_CMD_PIN
#define SDXC_CMD_PIN       DEFIO_TAG(PA3)
#endif

#ifndef SDXC_CMD_PIN_AF
#define SDXC_CMD_PIN_AF    IOC_PA03_FUNC_CTL_SDC0_CMD
#endif

#ifndef SDXC_CLK_PIN
#define SDXC_CLK_PIN       DEFIO_TAG(PA2)
#endif

#ifndef SDXC_DATA0_PIN
#define SDXC_DATA0_PIN     DEFIO_TAG(PA1)
#endif

#ifndef SDXC_DATA1_PIN
#define SDXC_DATA1_PIN     DEFIO_TAG(PA0)
#endif

#ifndef SDXC_DATA2_PIN
#define SDXC_DATA2_PIN     DEFIO_TAG(PA5)
#endif

#ifndef SDXC_DATA3_PIN
#define SDXC_DATA3_PIN     DEFIO_TAG(PA4)
#endif
